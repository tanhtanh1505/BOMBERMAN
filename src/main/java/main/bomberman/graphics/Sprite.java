...
public class Sprite {
    ...
    public static Image[] getListImage(String name, int number, int scale) throws MalformedURLException {
        Image[] imageArray = new Image[number];
        for (int i = 0; i < number; i++) {
            imageArray[i] = new Image(GetImage.get(name + i + ".png"));
    ...
    public static Image[][] getListImage(String name, int row, int col, int scale) throws MalformedURLException {
